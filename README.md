...
The page is typeset in the browser from [`diffusion.tex`](diffusion.tex) by hatex, a LaTeX-to-HTML renderer. There is no build step: `index.html` fetches the `.tex` file and renders it.
...
hatex/          hatex.js + hatex.css (v1.1.0)
```
